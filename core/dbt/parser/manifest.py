...
def _process_metric_node(
    ...
    if metric.type is MetricType.SIMPLE or metric.type is MetricType.CUMULATIVE:
        ...
        metric.type_params.add_input_measure(metric.type_params.measure)
        ...
        metric.type_params.add_input_measure(conversion_type_params.base_measure)
        metric.type_params.add_input_measure(conversion_type_params.conversion_measure)
        _process_metric_depends_on(
            manifest=manifest, current_project=current_project, metric=metric
        )
        ...
        for input_metric in input_metrics:
            ...
            for input_measure in target_metric.type_params.input_measures:
                metric.type_params.add_input_measure(input_measure)
